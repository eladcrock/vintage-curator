...
export const REGIONS: Region[] = [
  ...
  },
  {
    ...
    x: 19, y: 22,
    summary: "Tiny Alpine region with indigenous varieties and high-altitude, mineral-driven character. Pinot Grigio is called Malvoisie here.",
    grapes: [
  ...
  },
  {
    ...
    grapes: [
      ...
      { name: "Gewurztraminer / Riesling", kind: "white", notes: "Aromatic Alpine whites." },
    ],
  ...
  },
  {
    ...
    grapes: [
      ...
      { name: "Vernaccia di San Gimignano", kind: "white", notes: "Tuscany's white DOCG." },
    ],
    wineMatch: ["tuscany", "chianti", "brunello", "rosso di montalcino", "vino nobile", "montepulciano", "sangiovese", "bolgheri", "super tuscan", "rufina", "cortona", "montosoli", "podernovi", "santa caterina"],
  },
  {
  ...
  },
  {
    ...
    grapes: [
      { name: "Trebbiano d'Abruzzo", kind: "white", notes: "Medium body, saline, mineral,